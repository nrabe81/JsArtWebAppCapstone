...
public class ProductController
{
    ...
    {
        //return to login page if time out
        if(principal == null)
        {
            LOGGER.error("Return to login");
    ...
    public String enabledProduct(@PathVariable("id")Long id, RedirectAttributes attributes){
        try {
            ...
            LOGGER.info("Enabled product successfully");
        }
        catch (Exception e)
        {
            e.printStackTrace();
            attributes.addFlashAttribute("error", "Failed to enabled");
            LOGGER.error("Failed to enabled product");
        }
    ...
    public String deletedProduct(@PathVariable("id") Long id, RedirectAttributes attributes){
        try
        {
            ...
            LOGGER.info("Disabled product successfully");
        }
        catch (Exception e)
        {
            e.printStackTrace();
            attributes.addFlashAttribute("error", "Failed to disable");
            LOGGER.error("Failed to disable product");
        }
        return "redirect:/products";
    }
}
